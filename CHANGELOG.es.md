...
Este es el changelog secundario en español. `CHANGELOG.md` es el changelog
principal en inglés. Actualiza ambos ficheros a la vez al añadir o publicar una
versión para que App Store Connect pueda ofrecer notas en los dos idiomas.

## [Sin publicar]

- Deshacer al borrar en historial y favoritos, compartir el veredicto, y el veredicto ya se anuncia con lector de pantalla.
