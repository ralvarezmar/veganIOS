...
The CD workflow is responsible for deploying the application to the desired environment. It includes the following jobs:

![CD Workflow](../images/lifecycle/cd-wf.png)

- **Resolve Image Version**: Determines the version of the Docker image to be deployed.
...
- **Deployment Regions Matrix**: Defines the regions where the application will be deployed.
- **Deploy in Region Certification**: Deploys the application to the CERT environment.
- **Deploy in Region Preproduction**: Deploys the application to the PRE environment.
- **Deploy in Region Production**: Deploys the application to the PRO environment.
