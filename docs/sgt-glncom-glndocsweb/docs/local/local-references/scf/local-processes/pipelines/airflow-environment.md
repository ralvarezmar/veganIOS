---
title: SCF AirFlow Environment Adaptation Guide
---

This page aims to assist in the migration of components that previously relied on the ALM Multicloud pipeline `pipelineForApacheAirflowEnvironmentSettings` in Jenkins.
The guide focuses on the migration and adaptation of the GitHub repository files to comply with Gluon. Full information about to use these component templates can be found in the following documentations: [(SCF) Airflow Environment settings](https://gluon.gs.corp/community/docs/latest/local/local-references/scf/local-components/mwaa-environment-settings/).
...
In order to create the component go to your application in Gluon portal > Components > New Component and select `(SCF) Airflow Environment Settings`.

![Create Component](images/airflow-environment/create-component.png)
...
![Version](images/airflow-environment/version.png)
...
![Deployment](images/airflow-environment/deployment.png)
...
![Variables](images/airflow-environment/variables.png)
