---
title: React SPA Journey
---

## Introduction

The purpose of this documentation is to provide a **step-by-step guide** on how to create, build, analyze and deploy an SPA based on **React** framework within the GLUON platform.
...
You have to select the type of component you want to create, in this case you are going to create a **React SPA**.

![Create Component](images/create-react-spa-0.png)
...
![Component](images/create-react-spa-2.png)
...
The generated React SPA has a structure similar to the following (Depending the parameters you have previously configured):

=== "React Vite SPA Example"
...
=== "React CRA SPA Example"
    ...
    # Npm parameters
    NODE_VERSION='18.20.2'
    NPM_APPLICATION_DIST_DIRECTORY='build/'
    NPM_CONFIGURATION_DIST_DIRECTORY='nginx/'
    NPM_RUN_TEST_COMMAND='npm test -- --watchAll=false --coverage'
