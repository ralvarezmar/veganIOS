---
title: Use it in Angular - SPA
---

## Introduction

The purpose of this documentation is to provide a **step-by-step guide** on how to create, build, analyze and deploy an SPA with the standards of observability based on  **Thundera** within the GLUON platform.
...
To start your journey into the Darwin SPA go to [Darwin SPA/Shell Journey](../../darwin/spa.md) to setup your environment and starting application.
