# How to upgrade a Single Page Application (SPA) to Angular 10

This session is intended to guide you through upgrading from a Single Page Application (SPA) to Angular version 10.
...
A list of options will be presented. Select the **Application** option.
