...
``` BASH
npm install @afe/eslint-plugin-devkit-lint@^2 --save-dev
```
...
For ***Angular*** projects, another option is to use the builder [***@afe/devkit-angular:lint***](../../devkit-angular/v2/builders/lint/index.md)
