---
title: AFE Microfront Journey
---

## Introduction

The purpose of this documentation is to provide a **step-by-step guide** on how to create, build, analyze and deploy an Microfront based on **AFE** framework within the GLUON platform.
...
For more information about AFE, please refer to the [AFE documentation](../afe/framework/index.md).
...
You have to select the type of component you want to create, in this case you are going to create a **AFE Microfront**.

![Create Component](images/create-afe-mfe-0.png)
...
![Component](images/create-afe-mfe-2.png)
...
The generated AFE Microfront has a structure similar to the following (Depending the parameters you have previously configured):
...
📂projects
 ...
 ┗ 📂gln-demo-mycomponent
   ...
   | | ┣ 📂config
   | | | ┗ 📜url.config.ts
   | | ┣ 📜gln-demo-mycomponent.component.html
   | | ┣ 📜gln-demo-mycomponent.component.scss
   | | ┣ 📜gln-demo-mycomponent.component.spec.ts
   | | ┣ 📜gln-demo-mycomponent.component.ts
   | | ┣ 📜gln-demo-mycomponent.module.ts
   | ┣ assets
   | | ┗ 📜.gitkeep
   | ┣ 📜favicon.ico
   | ┣ 📜index.html
