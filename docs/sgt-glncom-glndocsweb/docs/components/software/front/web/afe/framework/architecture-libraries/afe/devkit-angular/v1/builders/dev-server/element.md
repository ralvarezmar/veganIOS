...
Builder responsible for providing a development server for projects of type **element**.

In this type of project, the builder **_[ngx-build-plus:browser](https://github.com/manfredsteyer/ngx-build-plus)_** is wrapped.

The Front-End Architecture tool **_@afe/devkit-angular:dev-server_** adds some processes such as **_prebuild_**, which consists of running **_lint_** referring to some standard rules of the architecture.

And also other routines that allow the project to be made available correctly.

## What is **_[ngx-build-plus:browser](https://github.com/manfredsteyer/ngx-build-plus)_**?
...
In addition to the settings that the builder **_@angular-devkit/build-angular:dev-server_** has, the following settings have been added:
...
The section below shows in detail how to use the available settings for the Front End Architecture builder **_@afe/devkit-angular:dev-server_** builder.
...
Property used in conjunction with **_singleBundle_** when set to **_true_** (**_singleBundle: true_**).

Generates a **_bundle_** of **_polyfill_** piece.
...
> It's necessary configure the property **_singleBundle** as **_true_** to work.
