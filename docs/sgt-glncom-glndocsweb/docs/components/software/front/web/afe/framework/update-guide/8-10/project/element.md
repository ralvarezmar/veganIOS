# How to upgrade an Element to Angular 10

This session is intended to guide you through upgrading from an Element to Angular version 10.
...
A list of options will be presented. Select the **Element** option.
