...
![Branch Release](../../../../../../../images/branch-release.png)

With the ***branch*** created, just run the ['afe version'] command, which will do some process to get your release ready, and then run the ***build*** in the ***DevOps*** Pipeline to generate a final version of the library.
...
![Merge for Integration Branches](../../../../../../../images/merge-integration.png)
