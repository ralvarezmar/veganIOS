...
By using the ***plugin:@afe/devkit-lint/javascript*** configuration, the project will rely on the following ESLint rules, and their respective configurations, that infer good practices
