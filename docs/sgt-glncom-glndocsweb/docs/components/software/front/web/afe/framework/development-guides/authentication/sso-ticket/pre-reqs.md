...
- **Solution Architecture**:
  ...
  - [SSO - Ticket](https://confluence.santanderbr.corp/display/BRARQTECI/SSO+-+Ticket)
- **Security Solutions**: - [SSO Ticket](https://confluence.santanderbr.corp/display/SOLSEG/SSO+Ticket)
...
>
> - [Request to create a Developer App or consume it in Apigee](https://confluence.santanderbr.corp/pages/viewpage.action?pageId=320908924) ## Installation ### Library ***@afe/authentication*** Install the library responsible for authentication.
