...
!!! note
    Please note that this documentation refers to the version 4 of the tool.
...
Darwin Front CLI requires Node.js >= 16.13.0 to run itself. But depending on the archetype you want to generate, you will need one or another Node version to run the archetype.
...
Usual parameters to generate a SPA with Angular 15
...
Usual parameters to generate a library with Angular 15
...
| `--frameworkVendor`      | Framework with which the archetype will be generated: (angular13, angular12, angular11)                                                                                                           | angular15             |
...
|----------------------------------|------------------------------------|
| **Angular 12**                   | `^14.20.0 || ^16.13.0 || ^18.10.0` |
| **Angular 11**                   | `^12.20.0 || ^14.15.0 || ^16.10.0` |
