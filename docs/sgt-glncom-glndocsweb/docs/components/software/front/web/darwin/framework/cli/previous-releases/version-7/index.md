...
!!! note
    **Please note that this documentation refers to the version 7 of the tool.**
...
Darwin Front CLI requires Node (`^16.14.0 || ^18.10.0 || ^20.11.0 || ^22.0.0`) to run itself. But depending on the archetype you want to generate, you will need one or another Node version to run the archetype.
...
``` bash
yo @darwin/front --useDefault --appName=foo --frameworkVendor angular18
```
...
Usual parameters to generate a Darwin SPA with Angular 18:

``` bash
yo @darwin/front --useDefault --architecture=darwin --projectType=spa --frameworkVendor=angular18 --projectKey=key --appStyleLanguage=css --appName=myproject --appPrefix=app --securityQueryParam=token --securityReminderTime=30000 --paasProjectName=paasProjectName_value --paasAppName=paasAppName_value --application=application_value --subApplication=00000000 --system=system_value --subSystem=subSystem_value
```

#### Generate a Library

!!! warning
    Library not available for Angular 18.
...
Usual parameters to generate a Darwin Microfront with Angular 18:

``` bash
yo @darwin/front --useDefault --architecture=darwin --projectType=mcf --frameworkVendor=angular18 --projectKey=key --appStyleLanguage=css --appName=myproject --appPrefix=app --securityQueryParam=token --securityReminderTime=30000 --paasProjectName=paasProjectName_value --paasAppName=paasAppName_value --application=application_value --subApplication=00000000 --system=system_value --subSystem=subSystem_value
```

#### Generate a Darwin Shell

Usual parameters to generate a Darwin Shell with Angular 18:

``` bash
yo @darwin/front --useDefault --architecture=darwin --projectType=shell --frameworkVendor=angular18 --projectKey=key --appStyleLanguage=css --appName=myproject --appPrefix=app --securityQueryParam=token --securityReminderTime=30000 --paasProjectName=paasProjectName_value --paasAppName=paasAppName_value --application=application_value --subApplication=00000000 --system=system_value --subSystem=subSystem_value
```
...
Usual parameters to generate a Gluon SPA with Angular 18:

``` bash
yo @darwin/front --useDefault --architecture=gluon --projectType=spa --frameworkVendor=angular18 --company=gln --projectKey=key --appStyleLanguage=css --appName=myproject --appPrefix=app --paasProjectName=paasProjectName_value --paasAppName=paasAppName_value --application=application_value --subApplication=00000000 --system=system_value --subSystem=subSystem_value
```
...
Usual parameters to generate a Gluon Microfront with Angular 18:

``` bash
yo @darwin/front --useDefault --architecture=gluon --projectType=mcf --frameworkVendor=angular18 --company=gln --projectKey=key --appStyleLanguage=css --appName=myproject --appPrefix=app --paasProjectName=paasProjectName_value --paasAppName=paasAppName_value --application=application_value --subApplication=00000000 --system=system_value --subSystem=subSystem_value
```

#### Generate a Gluon Shell

Usual parameters to generate a Gluon Shell with Angular 18:

``` bash
yo @darwin/front --useDefault --architecture=gluon --projectType=shell --frameworkVendor=angular18 --company=gln --projectKey=key --appStyleLanguage=css --appName=myproject --appPrefix=app --paasProjectName=paasProjectName_value --paasAppName=paasAppName_value --application=application_value --subApplication=00000000 --system=system_value --subSystem=subSystem_value
```
...
| `--frameworkVendor`      | Framework with which the archetype will be generated.<br><br>Values: `angular18`, `angular16`<br><br>Applicable to: `spa`, `lib`, `shell`, `mcf`                                                                     | `angular16`             |
...
| **SPA** (Gluon)                 | X              | X              |
| **Library** (Darwin Classic)    | No available   | X              |
