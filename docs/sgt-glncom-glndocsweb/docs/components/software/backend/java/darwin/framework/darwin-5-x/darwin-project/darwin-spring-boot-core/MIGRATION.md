...
!!! info "Important"
    ...
    For more information about how to configure a config server, the `Spring Cloud Config Client` [guide](https://docs.spring.io/spring-cloud-config/docs/4.1.x/reference/html/#_spring_cloud_config_client) is available.
