# Darwin Spring Boot WebService ![6.3.4](https://img.shields.io/badge/6.3.4-FF073D)
...
The `Darwin Spring Boot WebService` library provides the following functionalities depending on the application type:
...
| [WebEndPointSelectorService](https://gluon.dev.corp/microservices/docs/darwin-spring-boot/6.3.4/apidocs/com/santander/darwin/ws/service/WebEndPointSelectorService.html) | @Bean                                                                                                                                                              | Service to get the endpoint of the Webservice according to the channel                                                                                                                                          | <ul><li>NotWeb</li><li>Servlet</li></ul>  |
