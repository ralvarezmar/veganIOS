# Darwin Spring Boot Starters ![4.3.3-RELEASE](https://img.shields.io/badge/4.3.3-RELEASE-FF073D)
...
Installing one of these two starters as a `Maveb` dependency, we will get the necessary elements to automatically generate the traces with a specific `Json` format, and depending on which one we choose they will be managed by the monitoring
architecture or stay locally.
