# Darwin Spring Boot Batch ![4.3.3-RELEASE](https://img.shields.io/badge/4.3.3-RELEASE-FF073D)
...
included in the [Activity Log pattern](../darwin-spring-boot-logging/README.md#activity-pattern):
...
| Property                                             | Description                                                            | Required       | Value   | Environment |
|------------------------------------------------------|------------------------------------------------------------------------|----------------|---------|-------------|
| *darwin.batch.multipod.enabled*                      | Indicates whether the Multipod Utility must be loaded. Default: False  | No             | Boolean | Any         |
| *darwin.batch.multipod.multipod-info.dockerResource* | Indicates the docker image of the application that has to be launched. | Yes if enabled | String  | Any         |
...
This library cannot be used on micros that are compiled to a native image with graalvm native. We are not able to execute in native mode next libraries:
...
<!-- -->
       ...
       SftpRemoteFileTemplate template;
        ...
        public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
            ...
            Session<LsEntry> session = template.getSession(); (1)
