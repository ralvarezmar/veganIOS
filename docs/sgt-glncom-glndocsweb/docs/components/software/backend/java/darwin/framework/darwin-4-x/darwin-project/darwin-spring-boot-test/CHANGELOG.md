...
- Update Authentication mocks after unify STS connectors/service: use common MockSTSService,,
...
- Unifying MockMultiEntityCOCConnector and MockMultiEntityCONConnector into a single connector. MultiEntity logic has been simplified to use a single Control Operative Service.
