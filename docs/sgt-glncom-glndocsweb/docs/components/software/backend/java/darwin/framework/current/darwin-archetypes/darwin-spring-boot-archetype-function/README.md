# Darwin Spring Boot Function Archetype ![6.3.4](https://img.shields.io/badge/6.3.4-FF073D)
...
- Framework Darwin Spring Boot:
    ...
    - [Darwin Omnichannel](https://gluon.dev.corp/microservices/docs/darwin-spring-boot/6.3.4/darwin-project/darwin-spring-boot-omnichannel/)
    ...
    - [Darwin Metrics](https://gluon.dev.corp/microservices/docs/darwin-spring-boot/6.3.4/darwin-project/darwin-spring-boot-metrics/)
