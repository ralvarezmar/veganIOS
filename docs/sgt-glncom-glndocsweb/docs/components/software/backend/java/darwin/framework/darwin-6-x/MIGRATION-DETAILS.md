# DARWIN MIGRATION DETAILS ![6.3.4](https://img.shields.io/badge/6.3.4-FF073D)
...
## MIGRATION GUIDE FROM DARWIN 6.2.x TO 6.3.x

### Module: darwin-spring-boot-dependencies

{! include-markdown './darwin-project/darwin-spring-boot-dependencies/MIGRATION.md' start='<!tag:630>' end='<!end:630>' !}

### Module: darwin-spring-boot-core

{! include-markdown './darwin-project/darwin-spring-boot-core/MIGRATION.md' start='<!tag:630>' end='<!end:630>' !}

## MIGRATION GUIDE FROM DARWIN 5.5.x TO DARWIN 6.x

### Module: darwin-spring-boot-core

{! include-markdown './darwin-project/darwin-spring-boot-core/MIGRATION.md' start='<!tag:600>' end='<!end:600>' !}

### Module: darwin-dependencies

{! include-markdown './darwin-project/darwin-spring-boot-dependencies/MIGRATION.md' start='<!tag:600>' end='<!end:600>' !}

### Module: darwin-spring-boot-cache

{! include-markdown './darwin-project/darwin-spring-boot-cache/MIGRATION.md' start='<!tag:600>' end='<!end:600>' !}

### Module: darwin-archetypes

{! include-markdown './darwin-archetypes/darwin-spring-boot-archetype-microservice/MIGRATION.md' start='<!tag:600>' end='<!end:600>' !}

{! include-markdown './darwin-archetypes/darwin-spring-boot-archetype-library/MIGRATION.md' start='<!tag:600>' end='<!end:600>' !}

### Module: darwin-spring-boot-events

{! include-markdown './darwin-project/darwin-spring-boot-events/MIGRATION.md' start='<!tag:600>' end='<!end:600>' !}

### Module: darwin-spring-boot-logging

{! include-markdown './darwin-project/darwin-spring-boot-logging/MIGRATION.md' start='<!tag:600>' end='<!end:600>' !}
