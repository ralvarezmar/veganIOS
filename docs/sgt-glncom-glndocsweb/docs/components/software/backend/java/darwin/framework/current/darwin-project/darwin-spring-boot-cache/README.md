# Darwin Spring Boot Cache ![6.3.4](https://img.shields.io/badge/6.3.4-FF073D)
...
| darwin.cache.caffeine.async [see](README.md#darwincachemono-with-automatic-mode-enabled) | true                                                            | No        | Allows Caffeine caches to be created in asynchronous mode by default. Necessary for the use of cache annotations in reactive mode with Caffeine                                            | Boolean                                  |
| darwin.cache.caffeine.allow-null-values                                                  | true                                                            | No        | Allows null values to be stored in the cache. It's recommended to set it to false for performance reasons                                                                                  | Boolean                                  |
...
| infinispan.remote.reactive [see](README.md#darwincachemono-with-automatic-mode-enabled)  | true                                                            | No        | Add support to use Datagrid caches in reactive mode. Necessary to use cache annotations in reactive microservices                                                                          | Boolean                                  |
...
More information on how to use these annotations can be found in [cache-annotations](https://docs.spring.io/spring-framework/docs/6.2.12/reference/html/integration.html#cache-annotations)
...
More information on [Spring Boot - Caffeine](https://docs.spring.io/spring-boot/docs/3.5.7/reference/html/io.html#io.caching.provider.caffeine) and more detailed property specifications in
