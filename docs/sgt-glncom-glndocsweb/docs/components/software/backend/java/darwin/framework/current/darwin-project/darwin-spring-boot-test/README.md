# Darwin Spring Boot Test ![6.3.4](https://img.shields.io/badge/6.3.4-FF073D)
...
If the project includes the starter of [Darwin Metrics Library](https://gluon.dev.corp/microservices/docs/darwin-spring-boot/6.3.4/darwin-project/darwin-spring-boot-metrics/) among its dependencies,
...
### `AutoConfigureDarwinLogging` annotation
...
To use this functionality, we include the `AutoConfigureDarwinLogging` annotation in our test class.
...
| Name                        | Description                                                                                                     |
|-----------------------------|-----------------------------------------------------------------------------------------------------------------|
| @AutoConfigureDarwinLogging | Annotation to configure Darwin logging and a test *appender* to capture the traces sent to the ACTIVITY logger  |
...
The answers we can get with the original [Darwin CodeTables service](https://gluon.dev.corp/microservices/docs/darwin-spring-boot/6.3.4/apidocs/com/santander/darwin/codetables/service/package-summary.html) are:
...
you must also take into account the model [CodeTable](https://gluon.dev.corp/microservices/docs/darwin-spring-boot/6.3.4/apidocs/com/santander/darwin/codetables/domain/CodeTable.html)
that uses the [Darwin CodeTables library](https://gluon.dev.corp/microservices/docs/darwin-spring-boot/6.3.4/darwin-project/darwin-spring-boot-codetables/):
