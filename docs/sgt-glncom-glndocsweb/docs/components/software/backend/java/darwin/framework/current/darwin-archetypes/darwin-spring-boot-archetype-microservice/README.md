# Darwin Spring Boot Microservice Archetype ![6.3.4](https://img.shields.io/badge/6.3.4-FF073D)
...
- [Spring Web MVC](https://docs.spring.io/spring-framework/docs/6.2.12/reference/html/web.html#spring-web) y [Spring WebFlux](https://docs.spring.io/spring-framework/docs/6.2.12/reference/html/web-reactive.html#spring-webflux)

- [Spring Boot Actuator](https://docs.spring.io/spring-boot/docs/3.5.7/reference/html/actuator.html#actuator)
...
!!! note
    ...
    More information can be found at the following link: [Darwin Spring Boot Starters](https://gluon.dev.corp/microservices/docs/darwin-spring-boot/6.3.4/darwin-project/darwin-spring-boot-starters/).
...
- ***webAppType***: Application type of the [mentioned above](#application-types) that we want to generate in relation to the values of the Spring Boot
      [WebApplicationType](https://docs.spring.io/spring-boot/docs/3.5.7/api/org/springframework/boot/WebApplicationType.html) property. of Spring Boot.
...
```shell
mvn -B org.apache.maven.plugins:maven-archetype-plugin:3.3.1:generate -DarchetypeGroupId=com.santander.darwin -DarchetypeArtifactId=darwin-spring-boot-archetype-microservice -DarchetypeVersion=6.3.4 -Dcomponent-name=application-1 -Dacronym-app=myapps -DwebAppType=servlet
```
...
```shell
mvn -B org.apache.maven.plugins:maven-archetype-plugin:3.3.1:generate -DarchetypeGroupId=com.santander.darwin -DarchetypeArtifactId=darwin-spring-boot-archetype-microservice -DarchetypeVersion=6.3.4 -Dcomponent-name=applicationgluon -Dacronym-app=gluonapp -DwebAppType=reactive -Dgluon=Y -Dgluonlog-company=ESP -Dgluonlog-component-name=gluon-component -Dgluonlog-component-id=gluon-id -Dgluonlog-component-type=gluon-type -Dgluonlog-app-id=gluon-app-id
```
...
```shell
mvn -B org.apache.maven.plugins:maven-archetype-plugin:3.3.1:generate -DarchetypeGroupId=com.santander.darwin -DarchetypeArtifactId=darwin-spring-boot-archetype-microservice -DarchetypeVersion=6.3.4 -Dcomponent-name=application-1 -Dacronym-app=myapplication2 -DwebAppType=reactive -Dauthorization-library -Domnichannel-library -Dwebservice-component=Y
```
...
```shell
mvn -B org.apache.maven.plugins:maven-archetype-plugin:3.3.1:generate -DarchetypeGroupId=com.santander.darwin -DarchetypeArtifactId=darwin-spring-boot-archetype-microservice -DarchetypeVersion=6.3.4 -Dcomponent-name=application-1 -Dacronym-app=myapps -DwebAppType=servlet -Ddatabase-client=true -Ddatabase-client-type=postgresql
```
...
```shell
mvn -B org.apache.maven.plugins:maven-archetype-plugin:3.3.1:generate -DarchetypeGroupId=com.santander.darwin -DarchetypeArtifactId=darwin-spring-boot-archetype-microservice -DarchetypeVersion=6.3.4 -Dcomponent-name=applicationgluon -Dacronym-app=gluonapp -DwebAppType=reactive -Dgluon=Y -Dgluonlog-company=ESP -Dgluonlog-component-name=gluon-component -Dgluonlog-component-id=gluon-id -Dgluonlog-component-type=gluon-type -Dgluonlog-app-id=gluon-app-id -Dnative-compilation=true
```
...
```shell
mvn -B org.apache.maven.plugins:maven-archetype-plugin:3.3.1:generate -DarchetypeGroupId=com.santander.darwin -DarchetypeArtifactId=darwin-spring-boot-archetype-microservice -DarchetypeVersion=6.3.4 -Dcomponent-name=application-2 -Dacronym-app=myapps -DwebAppType=reactive -Dapi-first
```
...
```shell
mvn -B org.apache.maven.plugins:maven-archetype-plugin:3.3.1:generate -DarchetypeGroupId=com.santander.darwin -DarchetypeArtifactId=darwin-spring-boot-archetype-microservice -DarchetypeVersion=6.3.4 -Dcomponent-name=application-2 -Dacronym-app=myapps -DwebAppType=reactive -Dapi-first -Dapi-spec-url='https://catalog-api/domain/resources/openapi.yaml'
```
...
```shell
mvn -B org.apache.maven.plugins:maven-archetype-plugin:3.3.1:generate -DarchetypeGroupId=com.santander.darwin -DarchetypeArtifactId=darwin-spring-boot-archetype-microservice -DarchetypeVersion=6.3.4 -Dcomponent-name=application-1 -Dacronym-app=myapps -DwebAppType=reactive -Dgraphql
```
...
```shell
mvn -B org.apache.maven.plugins:maven-archetype-plugin:3.3.1:generate -DarchetypeGroupId=com.santander.darwin -DarchetypeArtifactId=darwin-spring-boot-archetype-microservice -DarchetypeVersion=6.3.4 -Dcomponent-name=Application-1 -Dacronym-app=myapps -DwebAppType=notweb
