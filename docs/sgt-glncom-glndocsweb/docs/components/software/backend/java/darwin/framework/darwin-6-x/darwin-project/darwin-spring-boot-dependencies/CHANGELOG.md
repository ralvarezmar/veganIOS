...
- Upgrade `spring-boot` to 3.5.7. Solve vulnerabilities **CVE-2025-49146** and **NVD - CVE-2025-11226**.
- Upgrade `bcprov-jdk18on` to 1.82.
- Upgrade `blockhound` to 1.0.15.RELEASE.
- Upgrade `swagger-annotations` to 2.2.40.
- Upgrade `flatten-maven-plugin` to 1.7.3.
- Upgrade `jacoco-maven-plugin` to 0.8.14.
- Upgrade `OWASP dependency-check` to 12.1.8.
...
- Upgrade `spring-boot` to 3.5.6.  Solve vulnerabilities **CVE-2025-41248** and **CVE-2025-41249**.
...
- Manage dependency `netty` version 4.1.126.Final. Solve vulnerability **CVE-2025-58056**.
- Removed `spring-framework` version. Managed by *Spring Boot*.
- Removed `tomcat` version Managed by *Spring Boot*.
...
- Upgrade `spring-boot` to 3.4.7.  Solve vulnerability **CVE-2025-48988**.
- Upgrade `springdoc-openapi-bom` to 2.8.9.
- Upgrade `org.owasp.dependency-check-maven` to 12.1.3.
- Upgrade `commons-io` to 2.19.0.
- Upgrade `partenon trxOp spring-boot` to 2.2.2.
- Upgrade `partenon sat spring-boot` to 2.1.1.
- Upgrade `mds-dualrun-lib` to 1.3.6.
- Upgrade `spring-javaformat-maven-plugin` to 0.0.46.
...
- Manage dependency `kafka` version 3.9.1. Solve vulnerability **CVE-2025-27817**.
...
- Upgrade `swagger-annotations` to 2.2.30 to solve issue using swagger-ui with version 6.1.1. Error `java.lang.NoSuchMethodError: 'java.lang.Class[] io.swagger.v3.oas.annotations.Parameter.validationGroups()'`.

### 🔨 Dependency Upgrades

- Manage dependency `springdoc-openapi-bom` version `2.8.8` instead of `springdoc-openapi-starter-webmvc-ui` and `springdoc-openapi-starter-webflux-ui`.
- Upgrade `swagger-annotations` to 2.2.30.
- Upgrade `spring-boot` to 3.4.6.
...
- Upgrade `springdoc-openapi` to 2.8.6.
...
- Upgrade `spring-boot` to 3.4.4. Solve vulnerability **CVE-2025-22228**.
- Upgrade `yauaa` to 7.30.0.
- Upgrade `spring-cloud` to 2024.0.1
- Removed `spring-framework` version. Managed by *Spring Boot*.
- Removed `tomcat` version. Managed by *Spring Boot*.
- Removed `netty` version. Managed by *Spring Boot*.
...
- Upgrade `tomcat` to 10.1.36. Solve vulnerability **CVE-2024-56337**.
- Upgrade `swagger-annotations` to 2.2.28.
- Upgrade `springdoc-openapi` to 2.8.5.
...
- Upgrade `springdoc-openapi` to 2.8.4
- Upgrade `infinispan` to 15.0.11.Final-redhat-00002
- Manage dependency `sshd-sftp` version 2.13.2. Solve [Apache Mina issue](https://github.com/apache/mina-sshd/issues/642)
- Manage dependency `okhttp` version 4.12.0. Solve vulnerabilities in `okhttp` 3.12.2 that `kubernetes-client` brings by default
- Upgrade `partenon-plugin` version 2.0.0.
- Upgrade `darwin-code-analysis-plugin` version 1.0.2
- Upgrade `org.owasp.dependency-check-maven` to 12.0.2
- Upgrade `openapi-generator-maven-plugin` to 7.11.0
