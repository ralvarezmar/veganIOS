# Darwin Spring Boot Test ![5.8.2](https://img.shields.io/badge/5.8.2-FF073D)
...
If the project includes the starter of [Darwin Metrics Library](https://gluon.dev.corp/microservices/docs/darwin-spring-boot/5.8.2/darwin-project/darwin-spring-boot-metrics/) among its dependencies,
...
If the project includes the [Authentication Library](../darwin-spring-boot-security-authentication/README.md) starter among its dependencies, **the module mockup the authentication** .
...
- Also allows you to use a default-defined key (modifiable in `darwin.test.security.public-key` and `darwin.test.security.private-key`)
...
It is possible to disable this mocks from the [configuration properties](#configuration-properties) of Test or all the Darwin security from [configuration
...
of Authentication or disabling the [Authentication mocks for Test](#authentication-mockup).
...
The answers we can get with the original [Darwin CodeTables service](https://gluon.dev.corp/microservices/docs/darwin-spring-boot/5.8.2/apidocs/com/santander/darwin/codetables/service/package-summary.html) are:
...
you must also take into account the model [CodeTable](https://gluon.dev.corp/microservices/docs/darwin-spring-boot/5.8.2/apidocs/com/santander/darwin/codetables/domain/CodeTable.html)
that uses the [Darwin CodeTables library](https://gluon.dev.corp/microservices/docs/darwin-spring-boot/5.8.2/darwin-project/darwin-spring-boot-codetables/):
