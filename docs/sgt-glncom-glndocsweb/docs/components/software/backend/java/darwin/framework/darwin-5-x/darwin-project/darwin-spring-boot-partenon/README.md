# Darwin Spring Boot Partenon ![5.8.2](https://img.shields.io/badge/5.8.2-FF073D)
...
example](https://gluon.dev.corp/microservices/docs/darwin-spring-boot/5.8.2/darwin-project/darwin-spring-boot-omnichannel/), and once the `DarwinContextHolder` finish executing the transaction:
...
we must follow the same steps defined [example of the Omnichannel library](https://gluon.dev.corp/microservices/docs/darwin-spring-boot/5.8.2/darwin-project/darwin-spring-boot-omnichannel/#how-to-retrieve-the-channel-from-the-darwincontext),
