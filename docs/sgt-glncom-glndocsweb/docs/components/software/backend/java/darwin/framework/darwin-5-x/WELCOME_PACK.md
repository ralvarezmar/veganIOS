# Spring Darwin Microservices Reference Guide ![5.8.2](https://img.shields.io/badge/5.8.2-FF073D)
...
- **Contract**. It would be the interface or contract between consumers and the microservice. In Spring Boot that would be the role of the @RestController class. With the aim for the contract to be more explicit, it is possible to use a Java interface.
  It is also desirable that the contract is created using the Springdoc library.
...
- **Persistence**. If the microservice has persistence (a Database for example) the objects of such database model, which are the entities, need to be created along with an access layer based on the Repository design pattern.
  Spring has a specific framework for this called Spring Data.

The package structure generated may vary depending on the type of application that you need. For example, a typical package structure for a servlet application with a database may be:

| Package    | Comments                                        |
|------------|-------------------------------------------------|
| config     | Spring Boot configuration classes               |
| infra      | Entity classes                                  |
...
The [recommendation](https://docs.spring.io/spring-framework/docs/6.1.20/reference/html/core.html#beans-factory-collaborators) by the developing team of Spring Framework:
...
documentation](https://docs.spring.io/spring-boot/docs/3.3.12/reference/html/features.html#features.external-config) defines the available mechanisms.
...
More information about Acturator in the [Spring Boot documentation](https://docs.spring.io/spring-boot/docs/3.3.12/reference/html/actuator.html#actuator).
...
To know the complete functionality of Spring MVC consult the [documentation](https://docs.spring.io/spring-framework/docs/6.1.20/reference/html/web.html#spring-web) of the project.
...
[documentation](https://docs.spring.io/spring-framework/docs/6.1.20/reference/html/web-reactive.html#spring-webflux) of the project. Darwin Spring Framework has integrations with Spring WebFlux in several of its modules: authentication, exception
...
- **Spring for Apache Kafka:** For the integration with *Kafka.* Consult the [project documentation](https://docs.spring.io/spring-kafka/docs/3.2.9/reference/html).
