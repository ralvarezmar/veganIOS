# Spring Darwin Microservices Reference Guide ![6.3.4](https://img.shields.io/badge/6.3.4-FF073D)
...
Java microservices should be configured following the [Darwin applications configuration guide](https://gluon.gs.corp/community/docs/latest/components/software/backend/java/darwin/standards/microservice-configuration/)

docs/components/software/backend/java/darwin/standards/microservice-configuration.md
...
Http error management should follow the instructions and have the format described in the [http services error handling guide](https://gluon.gs.corp/community/docs/latest/components/software/backend/java/darwin/standards/error-management/)
...
This adaptation to the hexagonal architecture for the darwin microservice archetype was led by Mexico's Development Center of Excellence.
...
The [recommendation](https://docs.spring.io/spring-framework/docs/6.2.12/reference/html/core.html#beans-factory-collaborators) by the developing team of Spring Framework:
...
documentation](https://docs.spring.io/spring-boot/docs/3.5.7/reference/html/features.html#features.external-config) defines the available mechanisms.
...
Detailed examples and guidelines for setting up java microservices are described within the following [document](https://gluon.gs.corp/community/docs/latest/components/software/backend/java/darwin/standards/microservice-configuration/).
...
More information about Acturator in the [Spring Boot documentation](https://docs.spring.io/spring-boot/docs/3.5.7/reference/html/actuator.html#actuator).
...
In the article: [Http error treatment](https://gluon.gs.corp/community/docs/latest/components/software/backend/java/darwin/standards/error-management/)
...
To know the complete functionality of Spring MVC consult the [documentation](https://docs.spring.io/spring-framework/docs/6.2.12/reference/html/web.html#spring-web) of the project.
...
[documentation](https://docs.spring.io/spring-framework/docs/6.2.12/reference/html/web-reactive.html#spring-webflux) of the project. Darwin Spring Framework has integrations with Spring WebFlux in several of its modules: authentication, exception
