# Darwin Spring Boot Logging ![6.3.4](https://img.shields.io/badge/6.3.4-FF073D)

![Current](https://img.shields.io/badge/CURRENT-30FF24) ![GA](https://img.shields.io/badge/GA-C81D11)

## Description

The `Darwin Spring Boot Logging Logback Kafka` library was born out of the need to send traces with Logback to Kafka.
...
<configuration>
    ...
    <appender name="kafkaAppender" class="com.santander.darwin.logging.logback.kafka.KafkaAppender">
...
You may also roll your own delivery strategy. Just extend `com.santander.darwin.logging.logback.kafka.delivery.DeliveryStrategy`.
...
```java
package foo;
import com.santander.darwin.logging.logback.kafka.keying.KeyingStrategy;
...
<configuration>
    ...
    <appender name="kafkaAppender" class="com.santander.darwin.logging.logback.kafka.KafkaAppender">
            ...
            <topic>logs</topic>
            <keyingStrategy class="com.santander.darwin.logging.logback.kafka.keying.NoKeyKeyingStrategy" />
            <deliveryStrategy class="com.santander.darwin.logging.logback.kafka.delivery.AsynchronousDeliveryStrategy" />
...
<!-- This example configuration is probably most unreliable under
    ...
    <appender name="very-relaxed-and-fast-kafka-appender" class="com.santander.darwin.logging.logback.kafka.KafkaAppender">
...
<!-- This example configuration is more restrictive and will try to ensure that every message
    ...
    <appender name="very-restrictive-kafka-appender" class="com.santander.darwin.logging.logback.kafka.KafkaAppender">
        <encoder class="ch.qos.logback.classic.encoder.PatternLayoutEncoder">
            <pattern>%d{HH:mm:ss.SSS} [%thread] %-5level %logger{36} - %msg%n</pattern>
        </encoder>
        ...
        <keyingStrategy class="com.santander.darwin.logging.logback.kafka.keying.HostNameKeyingStrategy" />
        <!-- block the logging application thread if the kafka appender cannot keep up with sending the log messages -->
        <deliveryStrategy class="com.santander.darwin.logging.logback.kafka.delivery.BlockingDeliveryStrategy">
