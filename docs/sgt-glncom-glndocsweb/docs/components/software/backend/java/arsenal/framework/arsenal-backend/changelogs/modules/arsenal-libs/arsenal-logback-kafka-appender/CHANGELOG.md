...
All notable changes to project `gln-back-arsenal-backend-archetype` will be documented in this file.
...
- Make kafka_2.13 to use same version of kafka client
...
- Class `com.github.danielwegener.logback.kafka.encoding.PatternLayoutKafkaMessageEncoder` has been renamed to `com.github.
danielwegener.logback.kafka.encoding.LayoutKafkaMessageEncoder` (#9). To ease the migration, there is still a deprecated class alias `PatternLayoutKafkaMessageEncoder`.
