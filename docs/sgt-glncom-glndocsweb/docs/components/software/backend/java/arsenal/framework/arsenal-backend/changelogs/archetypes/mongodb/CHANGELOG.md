...
All notable changes to project `gln-back-arsenal-backend-archetype-mongodb` will be documented in this file.
...
- Fixing security configuration for the archetype generation without security enabled
...
- Translate project Readme.md from portuguese to english.
...
- Adding observability fields to archetype
...
- Adding conditional to gluon error starter or default error starter
