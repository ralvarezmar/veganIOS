...
All notable changes to project `gln-back-arsenal-backend-event-driven-archetype` will be documented in this file.
...
- Correcting problem in application yaml
...
- Correcting version error starter
