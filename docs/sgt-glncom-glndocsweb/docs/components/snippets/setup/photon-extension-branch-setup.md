...
- Creates a **development**  with the structure of files and folders to configure and run your microservice.
![Photon Extension 2](images/gitflow-photon-extension-branches-github.png)
