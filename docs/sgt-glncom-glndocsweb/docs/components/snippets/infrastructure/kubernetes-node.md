...
- **Configuration** Configmap: By default, the microservice does not require a configuration file, but it's also possible to create a configmap in the namespace with your **external environment-dependent microservice configuration**.
