## Create Santander Spring Boot Component
...
The generated Santander Spring Boot microservice has a structure similar to the following:
...
???+ info "Note"
    ...
    please refer to the [Santander Spring Boot Microservice Archetype](../../software/backend/java/santander/framework/current/index.md) documentation
    provided by the framework.

#### Running the microservice
<!-- Start Running Microservice -->
It is necessary to add a couple of lines to test the **basic functionality** of this microservice (without a security token and without many of the libraries available in the Santander Spring Boot Framework).
