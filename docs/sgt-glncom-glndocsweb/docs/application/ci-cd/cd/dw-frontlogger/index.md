---
title: Darwin Front Logger
---

## Introduction

The Front Logger Service is a key component within Darwin's architecture, designed to receive and persist
logs from front-end applications. It uses Darwin's proprietary logging library, darwin-spring-boot-logging,
and integrates with Kafka to ensure efficient trace storage and management.
This service supports logging of various trace types, such as error traces, customer activity logs,
and arrays of different types of traces, using formats defined by architectural standards.
...
1. Select the type of component you want to create. In this case, create a **Darwin Front Logger**.

   ![Create Darwin Front Logger Component](images/create-front-logger.png)

2. Component Name Selection: Following the convention, assign a name that reflects the environment and functionality.

   ![Complete Darwin Front Logger Component](images/complete-front-logger.png)
...
3. Once the component is created, you’ll see a new repository under the application with the name of the component.
   ...
   ![Created Darwin Front Logger Component](images/created-component-front-logger.png)

### Darwin Front Logger Template
...
The generated Darwin Front Logger has a structure similar to the following:

##### Darwin Front Logger Structure

![Created Darwin Front Logger Component](images/workflow-scaffolding-front-logger.png)

![Created Darwin Front Logger Component](images/git-component-front-logger.png)

## Repository Structure and Key Files

## Workflows

Darwin Front Logger component includes the following workflows:

* `.github/workflows/`: contains the CI/CD workflows for creation and component updates.

* `cd.yml`: Deploys the Front Logger component using Helm.
...
To deploy front-logger in the cluster:
...
![Run Darwin Front Logger Component](images/run-front-logger.png)

**If you have any questions about the configuration on Darwin Front Logger**, contact the Spain Architecture Team or refer to:

[Darwin Front Logger](https://santandernet.sharepoint.com/sites/tech-platform-spain/SitePages/Back-End.aspx)
