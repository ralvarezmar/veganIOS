---
title: NPM Artifact Journey
---

## Introduction

The purpose of this documentation is to provide a **step-by-step guide** on how to build, upload and deploy (if applicable) artifact built with NPM.
...
![ NPM Library ](../../npm/image/create-npm.png)

???+ remember

    To follow the naming convention visit [Repository Naming Convention](../../../../../application/component-management/create-component.md#repository-naming-convention).

The user can customize the type of application that they want to create. For this example we have created a NPM Library with the following characteristics:
...
All artefacts will be upload in corporate [Nexus](https://nexus.alm.europe.cloudcenter.corp/) or Jfrog
...
#if applicable, node version properties
...
{!
   include-markdown "../../snippets/gitflow-artifact-npm.md"
!}
