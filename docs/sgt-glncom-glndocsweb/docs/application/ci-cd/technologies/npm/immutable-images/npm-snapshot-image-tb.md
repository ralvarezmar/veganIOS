...
## Integration (npm-snapshot-image-tb.yml)
...
![trunk-based-workflow-diagram.png](./../../../assets/images/workflows/integration-workflow-diagram.png)
...
check if the `package.json` version has the -BETA suffix. If it is not the case,
...
!}
  ...
  * `Deploying a development:` Deployment to the environment according to
  `SNAPSHOT_DEPLOYMENT_ENV` by default, property with possibility of
