...
## Release Candidate (npm-release-image-tb.yml)
...
* `Get pre release id:` Calls github api to get the pre release ID.
...
!}
  ...
  `CONTAINER_BUILD_ARGUMENTS` (`DOCKER_BUILD_ARGUMENTS` is deprecated)
...
[Release workflow link](https://github.com/santander-group-shared-assets/gln-user-reusable-workflows/blob/main/npm/immutable-images/npm-release-image.yml)
