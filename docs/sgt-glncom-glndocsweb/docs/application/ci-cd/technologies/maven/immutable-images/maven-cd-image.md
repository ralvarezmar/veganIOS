...
* `Generate tag and release:` Creates a new tag for RL and create a new release
  version from draft release generated in maven-rc-image workflow. It takes
  draft-it input from maven-rc-image workflow to create the new release
  from draft release.
...
[CD workflow link](https://github.com/santander-group-shared-assets/gln-user-reusable-workflows/blob/development/maven/immutable-images/maven-cd-image.yml)
