...
## Integration (maven-ci-image.yml)
...
![integration-workflow-diagram.png](./../../../assets/images/workflows/integration-workflow-diagram.png)
...
* `Container build and push:` It takes the feature or development branch as
  ...
  [multiregistry.yaml](https://github.com/santander-group-shared-assets/gln-alm-push-scan-multiregistry-action#readme)
  file.
...
[Integration workflow link](https://github.com/santander-group-shared-assets/gln-user-reusable-workflows/blob/main/maven/immutable-images/maven-ci-image.yml)
