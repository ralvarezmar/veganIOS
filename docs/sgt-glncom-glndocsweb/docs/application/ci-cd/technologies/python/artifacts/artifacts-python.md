---
title: Python Artifact Journey
---

## Introduction

The purpose of this documentation is to provide a **step-by-step guide** on how to build, upload and deploy (if applicable) artifact built with Python.
...
![Python Batch](../../python/image/create-python.png)

???+ remember

    To follow the naming convention visit [Repository Naming Convention](../../../../../application/component-management/create-component.md#repository-naming-convention).

The user can customize the type of application that they want to create. For this example we have created a Python Batch with the following characteristics:
...
{!
   include-markdown "../../snippets/gitflow-artifact-python.md"
!}
