...
The purpose of this documentation is to provide a **step-by-step guide** on how to build, push and deploy (if applicable) docker images
...
You have to select the type of component you want to create, in this case you are going to create a **Wordpress**.

![Create Wordpress Component](../docker/image/create-wordpress.png)
...
Create a development branch with the structure of files and folders to configure and build and push yor Docker Image.

TBD case

Create a main branch with the structure of files and folders to configure and build and push yor Docker Image.
...
Your images will be uploaded as development to the registry.

### How to configure your deployment environment, if your docker image is deployable

if your docker image is deployable, in addition to uploading to the registry, automatic scripts will be executed that will carry out the deployment in different environments.

{!
   include-markdown "../maven/snippets/snippet-oam-artifact.md"
