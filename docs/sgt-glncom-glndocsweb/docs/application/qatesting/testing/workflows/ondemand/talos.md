...
<!-- ondemand workflows talos execute start -->
{!
   include-markdown "../snippets/workflows-steps.md"
...
{!
   include-markdown "../snippets/workflows-steps.md"
   start="<!-- workflow steps talos start -->"
   end="<!-- workflow steps talos end -->"
!}
...
{!
   include-markdown "../snippets/workflows-steps.md"
   start="<!-- workflow talos results start -->"
   end="<!-- workflow talos results end -->"
!}

## Related content

[Talos Journey](../../../../../components/configuration/testing/talosbdd/journey/talosbdd-testing-journey.md)
